...
<body>
    ...
    <script>
        ...
        const economicVocab = [
            "aggregate demand", "aggregate supply", "allocative efficiency", "asymmetric information", "nominal", "real", "index", 
            ...
            "extension", "market failure", "oligopoly", "perfect competition", "price elasticity", "productive efficiency", 
            ...
            "long-run aggregate supply", "marginal revenue product of labor", "marginal cost", "marginal revenue", "average revenue", 
            ...
            "tariffs", "quotas", "subsidies", "expenditure-switching", "protectionism", "IMF", "international monetary fund", "WTO", 
            "world trade organization", "FDI", "foreign direct investment", "PPP", "PED", "YED", "XED", "AD", "SRAS", "LRAS", "MRPL", 
            "MC", "MR", "AR", "ATC", "BOE", "CPI", "MPS", "MPC", "GDP", "GNP", "PPF", "CPI", "BOP", "FX", "QE", "deficit", "WTO", "LDC", "cyclical"
        ];
        ...
        const connectives = [
            ...
            "depends on", "means that", "leads to"
        ];
        ...
        const keywords = {
            "KO": ["liquidity trap", "output gap", "derived demand", "disinflation"],
            "AN": ["price", "quantity", "shifts", "moves", "increases", "decreases", "contraction", "expansion", "extension", "movement"],
            "CXT": ["example", "instance", "to illustrate", "illustrates", "such as", "like", "context", "demonstrated", "seen by", "illustrated"],
            "EVAL": ["long-term", "interventionist", "long run", "short run", "depends", "but"]
        };
        ...
        function analyzeEssayText(essay) {
            ...
            paragraphs.forEach((paragraph) => {
                ...
                sentences.forEach((sentence) => {
                    ...
                    totalAdvancedVocab += words.filter(word => advancedVocab.includes(word.toLowerCase())).length;
            ...
            htmlContent += `
                ...
                <table class="compact-table">
                    ...
                    <tr>
                        ...
                        <td class="${analysis.totalAdvancedVocab < 13 ? 'red-text' : ''}">${analysis.totalAdvancedVocab} words</td>
                        <td class="small-text">Number of unique tech vocab words. </td>
                    </tr>
                    <tr>
                        <td>Total Words</td>
                        <td class="${analysis.totalWords > 900 ? 'red-text' : ''}">${analysis.totalWords}</td>
                        <td class="small-text">Total number of words in the essay.</td>
                    </tr>
                    <tr>
                        <td>Reasoning Steps</td>
                        <td class="${analysis.reasoningSteps < 15 ? 'red-text' : ''}">${analysis.reasoningSteps}</td>
                    ...
                    <tr>
                        ...
                        <td class="${analysis.averageParagraphLength < 5 || analysis.averageParagraphLength > 10 ? 'red-text' : ''}">${analysis.averageParagraphLength.toFixed(2)} sentences</td>
                        <td class="small-text">Average number of sentences per paragraph, (efficiency guide 7). </td>
                    </tr>
                    <tr>
                        <td>Avg. Connectives per Paragraph</td>
                        <td class="${analysis.averageConnectivesPerParagraph < 4 ? 'red-text' : ''}">${analysis.averageConnectivesPerParagraph.toFixed(2)}</td>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Economics Flashcard Quiz</title>
    <style>
        body {
            font-family: Arial, sans-serif;
...
<body>
    <div class="password-prompt">
        <h1>Economics Flashcard Quiz</h1>
        <p>Enter the password to access the flashcards:</p>
    ...
    <div id="flashcards-container" style="display: none;">
        <h1>Economics Flashcard Quiz</h1>
        <p>Click on each flashcard to reveal the answer. Test your knowledge of key economic concepts!</p>
    </div>
    ...
    <script>
        ...
        function loadFlashcards() {
            ...
            flashcards.forEach((card, index) => {
                ...
                answerElement.textContent = `A: ${card.answer}`;
                ...
                cardElement.appendChild(revealButton);
